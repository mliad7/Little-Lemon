...
import zandra from '../assets/zandra.jpg';
import andrea from '../assets/andrea.jpg';
import lhea from '../assets/lhea.jpg';
import resturantChefB from '../assets/restaurantChefB.jpg';
import bookingConfirmed from '../assets/bookingConfirmed.png';
import underConstruction from '../assets/underConstruction.PNG';

export default {logo, greekSalad, resturantFood, lemonDessert, bruchetta, MarioandAdrianA, MarioandAdrianb, resturant, chloe, zandra, andrea, lhea, resturantChefB, bookingConfirmed, underConstruction};