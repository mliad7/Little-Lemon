...
const reviews = [
    {image: images.chloe, name: "Chloe", reviewText: "Review rext rext lorem ipsudolar"},
    {image: images.zandra, name: "Zandra", reviewText: "Review rext rext lorem ipsudolar"},
    {image: images.andrea, name: "Andrea", reviewText: "Review rext rext lorem ipsudolar"},
    {image: images.lhea, name: "Lhea", reviewText: "Review rext rext lorem ipsudolar"},
]
